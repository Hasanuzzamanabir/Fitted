...
//               style: FontManager.dmSansH3().copyWith(color: Colors.white),
//             ),
...
class HomeView extends StatelessWidget {
  ...
  static final List<BoxShadow> pinkGlowShadow = [
    BoxShadow(
      color: const Color(0xFFFF4B6B).withOpacity(0.15),
      blurRadius: 16.r,
      spreadRadius: 1.r,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Good morning,",
              style: FontManager.playfairH3().copyWith(color: Colors.white, height: 1.1),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            Text(
              "Three events. One wardrobe.",
              style: FontManager.dmSansH3().copyWith(color: Colors.white, height: 1.1),
            ),
            SizedBox(height: 24.h),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            SizedBox(height: 12.h),
            Container(
              decoration: BoxDecoration(boxShadow: pinkGlowShadow),
              child: const TodayPickCard(
                imageUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb',
                title: "Crimson Rooftop",
                vibeMatch: "4.9",
                avatarUrls: [
            ...
            Row(
              ...
              children: [
                HomeTabButton(
                  label: "+ Plan Outfit",
                  themeColor: AppColors.primecolor,
