  ...
  void regenerateOutfit(String prompt) {
    if (prompt.isNotEmpty) {
      ...
      if (_useSecondSet) {
        ...
        _currentCoverImage = 'https://images.unsplash.com/photo-1534528741775-53994a69daeb';
        _breakdownItems[0]["image"] = 'https://images.unsplash.com/photo-1603252109303-2751441dd157?q=80&w=600&auto=format&fit=crop';
        _breakdownItems[1]["image"] = 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=600&auto=format&fit=crop';
        _breakdownItems[2]["image"] = 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=600&auto=format&fit=crop';
        _breakdownItems[3]["image"] = 'https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?q=80&w=600&auto=format&fit=crop';
      }
      notifyListeners();
    }
  }
