...
// class OutfitRecommendationView extends StatefulWidget {
//   const OutfitRecommendationView({super.key});
//   static const String outfitRecommendationView = '/outfitRecommendationView';

//   @override
//   State<OutfitRecommendationView> createState() => _OutfitRecommendationViewState();
// }

// class _OutfitRecommendationViewState extends State<OutfitRecommendationView> {
//   bool isExpanded = false;

//   final List<Map<String, String>> breakdownItems = [
//     {
...
// void _showTryAnotherVibeBottomSheet(BuildContext context) {
